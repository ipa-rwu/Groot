...
public slots:
  ...
  void onRequestSubTreeExpand(GraphicContainer &container, QtNodes::Node &node);
...
private:
  ...
  void streamElementAttributes(QXmlStreamWriter &stream,
                               const QDomElement &element) const;

  QString xmlDocumentToString(const QDomDocument &document) const;

  void recursivelySaveNodeCanonically(QXmlStreamWriter &stream,
  ...
  QtNodes::Node *subTreeExpand(GraphicContainer &container, QtNodes::Node &node,
